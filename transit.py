...
def keplerian_transit(t, u1, u2, p, r, t0, a, i, e, w):
...
def eastman_from_canon(per, r, t0, a, i, e, w):
...
def reparam(t, p):
    ...
    C = p[-4]
    u1, u2 = p[:2]
    per, r, t0, a, inc, e, w = canon_from_eastman(*p[2:])
...
def eastman_priors(per, r, t0, a, V, C, Ls, Lc, S):
