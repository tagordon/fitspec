...
def get_pca_cube(wavs, wav_bin_edges, cube, ind, n_components=5, trim_edges=2):
...
def gls_fit(time, data, pca_components=None, mask=None, polyorder=2, return_coeffs=False):
